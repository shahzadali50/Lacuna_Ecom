        ...
        <form class="w-full" v-else @submit.prevent="orderGenerate()">
          ...
          <Row class="justify-between px-6">
            <Col :xs="24" :md="10" class="mb-5">
              <div>
                <h1
                  class="text-5xl font-bold text-green-800 mb-6 flex items-center gap-2"
                >
                  1.
                </h1>
                <h1
              ...
              <div class="mb-4">
                <label class="block"
                  >{{ translations.pcode || "Postal Code" }}
                  <span class="text-red-500">*</span></label
                >
                <a-input
                  type="number"
              ...
              <div class="mb-4">
                ...
                <a-textarea
                  v-model:value="form.order_notes"
                  class="mt-2 w-full"
