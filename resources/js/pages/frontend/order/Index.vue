      ...
      <a-row>
        <a-col :xs="24">
          <div class="mb-4">
            ...
            <a-row :gutter="16">
              <a-col :xs="24" :sm="12">
                <p class="mb-2">
                  <span class="font-semibold">Name:</span> {{ selectedOrder.name }}
                </p>
                <p class="mb-2">
                ...
                <p class="mb-2">
                  <span class="font-semibold">Email:</span> {{ selectedOrder.email }}
                </p>
              </a-col>
              <a-col :xs="24" :sm="12">
                <p class="mb-2">
                  <span class="font-semibold">Address:</span> {{ selectedOrder.address }}
                </p>
                <p class="mb-2">
                  <span class="font-semibold">City:</span> {{ selectedOrder.city }}
                </p>
                <p class="mb-2">
                  <span class="font-semibold">State:</span> {{ selectedOrder.state }}
                </p>
                <p class="mb-2">
                ...
                <p class="mb-2">
                  <span class="font-semibold">Country:</span> {{ selectedOrder.country }}
                </p>
              </a-col>
            </a-row>
            <div v-if="selectedOrder.order_notes" class="mt-2">
              <p class="mb-2">
                <span class="font-semibold">Order Notes:</span>
        ...
        <a-col :xs="24">
          <div class="mb-2 overflow-x-auto">
            ...
            <table class="table-auto w-full min-w-[600px]">
              ...
              <tbody>
                <tr
                  v-for="(sale, index) in selectedOrder?.sale_products"
                  :key="sale.id"
                  class="border-b py-3"
                >
        ...
        <a-col :xs="24">
          ...
          <div class="my-3">
            ...
            <h4 class="mb-2">
              Shipping Charges: <span class="font-bold text-primary">Free Delivery</span>
            </h4>
            <h4 class="mb-2">
              Total Price:
              <span class="font-bold text-primary">{{ selectedOrder?.total_price }}</span>
            </h4>
          </div>
        </a-col>
      </a-row>
